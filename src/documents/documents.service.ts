...
export class DocumentsService {
  async generatePdf(data: any, url): Promise<Buffer> {
    ...
    const imagePathSignature = path.resolve(
      __dirname,
      '../public/images/Signature.png',
    );
    const imagePathAddress = path.resolve(
      __dirname,
      '../public/images/Address.png',
    );
    const imagePathViber = path.resolve(
      __dirname,
      '../public/images/Viber.png',
    );
    const imagePathEmail = path.resolve(
      __dirname,
